...
<p>&nbsp;</p>
<p class=violethead align=center>Updating Category</p>
	<html:errors />
	<html:form action="/EditCategory" name="categoryForm" type="com.wiley.CategoryForm" scope="request" >
	...
	<tr>
		<td class=yellowtext><bean:message key="olns.category" /></td>
...
<br><br><table align=center bgcolor="#AE62AC" width=100>
